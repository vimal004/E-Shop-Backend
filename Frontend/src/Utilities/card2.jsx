...
const Card = ({ name, imageLink, rating, price, mode, qty }) => {
  return (
    <div
      className={`w-full max-w-sm h-40 flex rounded-lg overflow-hidden shadow-lg border border-gray-300 transform transition-transform duration-300 hover:scale-105 ${
